...
func addTotalProductsSalesOrder(orderId int64, totalAmount float32, vatPercent float32) bool {
...
// THIS FUNCTION DOES NOT OPEN A TRANSACTION.
func addDiscountsSalesOrder(orderId int64, amountTaxExcluded float32) bool {
