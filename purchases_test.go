...
func TestGetPurchaseOrderRelations(t *testing.T) {
	...
	for i := 0; i < len(o); i++ {
		r := getPurchaseOrderRelations(o[i].Id)
...
func TestPurchaseOrderDetailInsertUpdateDelete(t *testing.T) {
	...
	details := getPurchaseOrderDetail(orderId)
	if details[0].Id <= 0 {
...
func TestGetSalesOrderDetailsFromPurchaseOrderDetail(t *testing.T) {
	...
	o := getPurchaseOrder()
	for i := 0; i < len(o); i++ {
		d := getPurchaseOrderDetail(o[i].Id)
		for j := 0; j < len(d); j++ {
			salesDetails := getSalesOrderDetailsFromPurchaseOrderDetail(d[j].Id)
...
func TestInvoiceAllPurchaseOrder(t *testing.T) {
	...
	ok := invoiceAllPurchaseOrder(orderId)
	if !ok {
	...
	r := getPurchaseOrderRelations(orderId)
...
func TestIInvoicePartiallyPurchaseOrder(t *testing.T) {
	...
	ok := invoiceInfo.invoicePartiallyPurchaseOrder()
	if !ok {
...
func TestGetPurchaseInvoiceRelations(t *testing.T) {
	...
	for i := 0; i < len(o); i++ {
		r := getPurchaseInvoiceRelations(o[i].Id)
...
func TestPurchaseInvoiceDetailInsertUpdateDelete(t *testing.T) {
	...
	details := getPurchaseInvoiceDetail(invoiceId)
...
func TestDeliveryNoteAllPurchaseOrder(t *testing.T) {
	...
	ok, noteId := deliveryNoteAllPurchaseOrder(orderId)
	if !ok || noteId <= 0 {
	...
	if !ok {
		t.Error("The delivert note creted could not be deleted")
		return
	}
...
func TestDeliveryNotePartiallyPurchaseOrder(t *testing.T) {
	...
	ok := invoiceInfo.deliveryNotePartiallyPurchaseOrder()
	if !ok {
