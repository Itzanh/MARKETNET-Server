...
func getSettingsRecordByEnterprise(enterpriseKey string) Settings {
	...
	row := db.QueryRow(sqlStatement, enterpriseKey)
	if row.Err() != nil {
		return Settings{}
	}
