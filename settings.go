...
type Settings struct {
	...
	Ecommerce                       string     `json:"ecommerce"` // "_" = None, "P" = PrestaShop, "M" = Magento, "W" = "WooCommerce"
